...
class UserProfile(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_authenticated:
            ...
            promotions_cache_key = 'promotions:{}'.format(self.request.user.username)
            offers_cache_key = 'offers:{}'.format(self.request.user.username)
            
            promotions = Promotion.objects.filter(expire_at__gt=timezone.now())
            offers = Offer.objects.filter(expire_at__gt=timezone.now())
            ...
            context['promotions_list'] = promotions
